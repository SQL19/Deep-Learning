...
class BERTBaseUncased(nn.Module):
    def __init__(self):
        ...
        # fetch the model from the BERT_PATH defined in config_transformer.py
        self.bert = transformers.BertModel.from_pretrained(config_transformer.BERT_PATH)
    ...
    def forward(self, ids, mask, token_type_ids):
        ...
        # you might want to use last hidden state or several hidden states
        _, o2 = self.bert(
            ids,
            attention_mask=mask, token_type_ids=token_type_ids
        )
